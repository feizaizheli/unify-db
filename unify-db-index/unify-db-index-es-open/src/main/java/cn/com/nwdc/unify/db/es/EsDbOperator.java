package cn.com.nwdc.unify.db.es;


import cn.com.nwdc.unify.db.AbstractDbOperator;
import cn.com.nwdc.unify.db.anno.cache.TableInfoHelper;
import cn.com.nwdc.unify.db.anno.cache.info.TableInfo;
import cn.com.nwdc.unify.db.elem.DbElement;
import cn.com.nwdc.unify.db.index.common.IndexDbCondition;
import cn.com.nwdc.unify.db.index.common.IndexDbTemplate;
...
import cn.com.nwdc.unify.db.index.common.utils.EsBeanUtils;
import cn.com.nwdc.unify.db.es.config.EsConfig;
import cn.com.nwdc.unify.db.pageinfo.PageInfo;
import cn.com.nwdc.unify.utils.MapUtils;
    ...
    private void doBulk(List<ELEM> elemList,String updateFlag) {
        ...
        for (ELEM elem : elemList) {
            if (elem instanceof DbElement) {
                ...
                dbElement = EsBeanUtils.toDbElement(elem);
            }
