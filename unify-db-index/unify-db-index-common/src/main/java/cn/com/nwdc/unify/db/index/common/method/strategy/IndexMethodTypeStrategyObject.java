...
public class IndexMethodTypeStrategyObject extends AbstractIndexMethodTypeStrategy<Object> {
    ...
    protected Object executeUpdate(Object proxy, String templateName, IndexMapperMethod.MethodSignature methodSignature) {
        ...
        Method esMethod = ClassUtil.getDeclaredMethod(indexDbOperator,method.getName(),method.getParameterTypes());
        ...
        if(esMethod!=null){
            ...
            return ClassUtil.invokeMethod(indexDbOperator,method.getName(),method.getParameterTypes(),methodSignature.getArgVals());
     ...
     //   indexDbOperator.executeRestRequest()
