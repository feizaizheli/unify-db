 ...
 * @Date 2017-01-04
 */
public class IndexXMLConfigBuilder extends BaseBuilder {
    ...
    public IndexXMLConfigBuilder(Reader reader) {
        this(reader, null, null);
    }

    public IndexXMLConfigBuilder(Reader reader, String environment) {
        this(reader, environment, null);
    }

    public IndexXMLConfigBuilder(Reader reader, String environment, Properties props) {
        this(new XPathParser(reader, true, props, new XMLMapperEntityResolver()), environment, props);
    }

    public IndexXMLConfigBuilder(InputStream inputStream) {
        this(inputStream, null, null);
    }

    public IndexXMLConfigBuilder(InputStream inputStream, String environment) {
        this(inputStream, environment, null);
    }

    public IndexXMLConfigBuilder(InputStream inputStream, String environment, Properties props) {
        this(new XPathParser(inputStream, true, props, new XMLMapperEntityResolver()), environment, props);
    }

    private IndexXMLConfigBuilder(XPathParser parser, String environment, Properties props) {
        //TODO 自定义 Configuration
        super(new IndexConfiguration());
